    ...
    useEffect(() => {
        if (theme) {
            if (
                ...
                setStyle('header_one')
            } else if (theme == 'fashion_oned') {
                setStyle('header_three')
            } else if (
                theme == 'fashion_ones' ||
                theme == 'jewellery_one' ||
                theme == 'christmas' ||
                theme == 'digital_download' ||
                theme == 'single_product'
            ) {
            ...
            } else if (theme == 'fashion_ones' || theme == 'full_page') {
                setStyle('header_eight')
            }
        } else {
            let defaultStyle = themeOption?.header
                ? themeOption?.header?.header_options
                : 'header_one'
